...
<<<<<<< HEAD
                    ...
                    ElevatedButton(onPressed: (){
                      ...
                      },style: ElevatedButton.styleFrom(backgroundColor: Colors.black54, padding: EdgeInsets.all(12)),
              ...
              ElevatedButton(onPressed: (){
               ...
               style: ElevatedButton.styleFrom(backgroundColor: Colors.black54, padding: const EdgeInsets.all(12)),
                child: const Text("CLICK ME !!", style: TextStyle(fontSize: 30, fontWeight: FontWeight.w500)))
        ],
      ),
      ));
=======
